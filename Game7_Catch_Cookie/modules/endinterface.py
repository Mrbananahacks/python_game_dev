...
def showEndInterface(screen, cfg, score, highest_score): #everything we want to show in our end screen
    ...
    while True:
        ...
        if text_tip_count % text_tip_freq == 0:
            text_tip_count = 0
            text_tip_count = not text_tip_show_flag
        pygame.display.flip()
        clock.tick(cfg.FPS)
